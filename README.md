...
- [📝 AstrBot 列表提醒插件 v2.2](#-astrbot-列表提醒插件-v22)
  - [📑 目录](#-目录)
  - [🚀 功能特点](#-功能特点)
  - [📦 安装方法](#-安装方法)
  - [🛠️ 第一次使用](#️-第一次使用)
...
| 🖥️ WebUI 管理界面       | 独立的后台管理界面，可查看、创建、编辑和删除任务，支持昵称/标签筛选与完成状态切换显示                         |
...
使用返回的密钥登录后即可进入管理界面。界面展示当前用户的任务列表（未完成任务优先展示），支持：

- 查看任务内容、到期时间与标签
- 创建任务，并可绑定标签（管理员还可按标签批量填充任务所有者）
- 编辑任务的内容、到期时间、任务所有者（sender_id）与标签
- 按昵称、标签筛选任务，并可一键切换显示/隐藏未完成任务、已完成任务
- 删除已完成或不再需要的任务
