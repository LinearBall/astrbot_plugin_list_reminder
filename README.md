...
[![Version](https://img.shields.io/badge/Version-v1.1.1-blue)](https://github.com/LinearBall/astrbot_plugin_list_reminder/releases)

</div>

## 📑 目录

- [📝 AstrBot 列表提醒（备忘录）](#-astrbot-列表提醒备忘录)
  - [📑 目录](#-目录)
  - [🚀 功能特点](#-功能特点)
  - [📦 安装方法](#-安装方法)
  - [🛠️ 第一次使用](#️-第一次使用)
...
发送 `/列表提醒 后台` 后，机器人会返回访问地址与个人登录密钥：
